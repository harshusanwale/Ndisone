...
<section class="<?php if ($footer_row['admin_language'] == 2) {
    ...
    <div class="fed-box">
        ...
        <div class="rhs">
            ...
            <ul>
                <li><a href="#"><img src="images/icon/facebook.png" alt="" loading="lazy"></a></li>
                <li><a href="#"><img src="images/icon/twitter.png" alt="" loading="lazy"></a></li>
                <li><a href="#"><img src="images/icon/linkedin.png" alt="" loading="lazy"></a></li>
                <li><a href="#"><img src="images/icon/whatsapp.png" alt="" loading="lazy"></a></li>
            </ul>
