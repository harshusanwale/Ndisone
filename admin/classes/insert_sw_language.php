...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['lang_submit'])) {
	  ...
	  if($_POST['lang_name'] != NULL){
        ...
        $sw_lang_name_exist_check = mysqli_query($conn, "SELECT * FROM " . TBL . "sw_languages  WHERE language_name		='" . $sw_lang . "' ");
		...
		$sw_lang_qry = "INSERT INTO " . TBL . "sw_languages 
						(language_name, language_udt, language_cdt) 
						VALUES 
						('$sw_lang','$curDate','$curDate')";						
