...
function getAllQualificationsData($arg)
{
    global $conn;
    $sql = "SELECT * FROM " . TBL . "qualifications where type='".$arg."' ORDER BY qualifications_id DESC";
    $rs = mysqli_query($conn, $sql);
    return $rs;
}
...
{   global $conn;
    $sql = "SELECT * FROM " . TBL . "languages ORDER BY id ASC";
    $rs = mysqli_query($conn, $sql);
    return $rs;
}
