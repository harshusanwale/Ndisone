    ...
    <div class="ad-menu-lhs mshow">
        ...
        <div class="ad-menu">
            ...
            <ul>
                ...
                <li><h4>Registration Form</h4></li>

                <li class="ic-li">

                    <a href="#"

                        class="<?php if ($current_page == 'admin_all_plan_manage.php' || $current_page == 'add_plan_manage.php' || $current_page == 'delete_plan_manage.php' || $current_page == 'edit_plan_manage.php'|| $current_page == 'admin-all-parti-identify.php' || $current_page == 'add-part-identify.php' || $current_page == 'edit-part-identify.php' || $current_page == 'delete-part-identify.php' || $current_page == 'admin-all-rel-with-partici.php' || $current_page == 'add-rel-partici.php' || $current_page == 'delete-rel-parti.php' || $current_page == 'add-age-range.php' || $current_page == 'admin-all-age-range.php' || $current_page == 'delete-age-range.php' || $current_page == 'edit-age-range.php') {
                    ...
                    <div>
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                <a href="admin_all_plan_manage.php" class="<?php if($current_page=='add_plan_manage.php' || $current_page=='edit_plan_manage.php' || $current_page=='delete_plan_manage.php'){echo 's-act';}?>">All Plan Manage Options</a>

                            </li>

                            <li>

                                <a href="admin-all-parti-identify.php" class="<?php if($current_page=='add-part-identify.php' || $current_page=='edit-part-identify.php' || $current_page=='delete-part-identify.php'){echo 's-act';}?>">All Participant Identify Options</a>

                            </li>

                            <li>

                                <a href="admin-all-rel-with-partici.php" class="<?php if($current_page=='add-rel-partici.php' || $current_page=='edit-rel-partici.php' || $current_page=='delete-rel-parti.php'){echo 's-act';}?>">All Rel participant Options</a>

                            </li>

                            <li>

                                <a href="admin-all-age-range.php" class="<?php if($current_page=='add-age-range.php' || $current_page=='edit-age-range.php' || $current_page=='delete-age-range.php'){echo 's-act';}?>">All Age Range Options</a>
                    ...
                    <a href="#"
                        ...
                        class="<?php if ($current_page == 'admin-support_offers.php' || $current_page == 'admin_add_support_offer.php' || $current_page == 'admin-support-offer-edit.php' || $current_page == 'admin-delete-sup_offers.php' || $current_page == 'admin-supp-worker-type.php' || $current_page == 'add-supp-worker-type.php' || $current_page == 'edit_supp_worker_type.php' || $current_page == 'delete_supp_worker_type.php' || $current_page == 'admin_all_sw_about_us.php' || $current_page == 'admin_all_travel_distance.php' || $current_page == 'admin_all_sw_languages.php' || $current_page == 'admin_all_avail_time.php' || $current_page == 'admin_all_pet_frie.php' || $current_page == 'admin_all_supp_prefrence.php' || $current_page == 'add-about-us-option.php' || $current_page == 'delete_sw_about_us.php' || $current_page == 'edit_sw_about_us.php' || $current_page == 'add_travel_distance.php' || $current_page == 'edit_travel_distance.php' || $current_page == 'delete_sw_travel_distance.php' || $current_page == 'add_sw_lang.php' || $current_page == 'edit_sw_language.php' || $current_page == 'delete_sw_language.php' || $current_page == 'add_avail_time.php' || $current_page == 'edit_avail_time.php' || $current_page == 'delete_avail_time.php' || $current_page == 'add_pet_friendl.php'  || $current_page == 'delete_pet_frien.php'  || $current_page == 'edit_pet_frien.php' || $current_page == 'add_supp_prefrence.php' || $current_page == 'delete_supp_prefrence.php' || $current_page == 'edit_supp_prefrence.php' || $current_page == 'admin_add_support_offer.php' || $current_page == 'admin-support-offer-edit.php' || $current_page == 'admin-delete-sup_offers.php'

                         || $current_page == 'sw-plans.php' || $current_page== 'sw-plans-edit.php' || $current_page == 'admin-all-qualifications.php' || $current_page == 'admin-add-qualifications.php') {
                    ...
                    <div>
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                <a href="admin-support_offers.php" class="<?php if($current_page=='admin_add_support_offer.php'|| $current_page=='admin-delete-sup_offers.php' || $current_page=='admin-support-offer-edit.php'){echo 's-act';}?>">All Support offers</a>
                            ...
                            <li>
                                ...
                                <a href="admin-supp-worker-type.php" class="<?php if($current_page=='add-supp-worker-type.php' || $current_page=='edit_supp_worker_type.php' || $current_page=='delete_supp_worker_type.php'){echo 's-act';}?>">All Support Worker Types</a>

                            </li>

                            <li>

                                <a href="admin_all_sw_about_us.php" class="<?php if($current_page=='add-about-us-option.php' || $current_page=='edit_sw_about_us.php' || $current_page=='delete_sw_about_us.php'){echo 's-act';}?>">All About us Options</a>

                            </li>

                            <li>

                                <a href="admin_all_travel_distance.php" class="<?php if($current_page=='add_travel_distance.php' || $current_page=='edit_travel_distance.php' || $current_page=='delete_sw_travel_distance.php'){echo 's-act';}?>">All Travel Distance Options</a>

                            </li>

                            <li>

                                <a href="admin_all_sw_languages.php" class="<?php if($current_page=='add_sw_lang.php' || $current_page=='delete_sw_language.php' || $current_page=='edit_sw_language.php' ){echo 's-act';}?>">All Language Options</a>

                            </li>

                            <li>

                                <a href="admin_all_avail_time.php" class="<?php if($current_page=='add_avail_time.php' || $current_page=='edit_avail_time.php' || $current_page=='delete_avail_time.php' ){echo 's-act';}?>">All Availability Time Options</a>

                            </li>

                            <li>

                                <a href="admin_all_pet_frie.php" class="<?php if($current_page=='add_pet_friendl.php'){echo 's-act';}?>">All Pet friendly Options</a>

                            </li>

                            <li>

                                <a href="admin_all_supp_prefrence.php" class="<?php if($current_page=='add_supp_prefrence.php' || $current_page=='edit_pet_frien.php' || $current_page=='delete_pet_frien.php'){echo 's-act';}?>">Support Preference Options</a>

                            </li>

                            <li>

                            <a href="admin-all-qualifications.php" class="<?php if($current_page=='admin-add-qualifications.php' || $current_page=='admin-qualifications-edit.php' || $current_page=='admin-qualifications-delete.php'){echo 's-act';}?>">All Qualifications</a>

                            </li>

                            <li>

                                <a href="sw-plans.php" class="<?php if($current_page=='sw-plans-edit.php'){echo 's-act';}?>">Pricing Plans</a>
                ...
                <a href="#"
                    ...
                    class="<?php if ($current_page == 'admin-ser-pro-category.php' || $current_page == 'add_plan_manage.php.php' ) {
                ...
                <div>
                    ...
                    <ol>
                        ...
                        <li>
                            ...
                            <a href="admin-ser-pro-category.php">All Category</a>

                        </li>

                        <li>

                            <a href="admin-ser-pro-subcategory.php">All Sub Category</a>
...
class="<?php //if ($current_page == 'admin-all-qualifications.php' || $current_page == 'admin-add-qualifications.php') {
...
<li>
 ...
 <a href="admin-all-qualifications.php">All Qualifications</a>
 ...
 <a href="admin-add-qualifications.php">Add New Qualifications</a>
                ...
                <!-- <li><h4>Support Worker</h4></li>

                <li class="ic-eve">

                    <a href="#"

                        class="<?php if ($current_page == 'admin-support_offers.php' || $current_page == 'admin_add_support_offer.php' || $current_page == 'admin-support-offer-edit.php' || $current_page == 'admin-delete-sup_offers.php') {
                    ...
                    <div>
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                <a href="admin-support_offers.php">All Support offers</a>
                ...
                <li class="ic-eve">
                    ...
                    <a href="#"
                        ...
                        class="<?php if ($current_page == 'admin-supp-worker-type.php' || $current_page == 'add-supp-worker-type.php' || $current_page == 'edit_supp_worker_type.php.php' || $current_page == 'delete_supp_worker_type.php' ) {

                            echo 'mact';

                        } ?>">Support Worker Types</a>
                    ...
                    <div>
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                <a href="admin-supp-worker-type.php">All Support Worker Types</a>
                ...
                <li class="ic-eve">
                    ...
                    <a href="#"
                        ...
                        class="<?php if ($current_page == 'admin_all_sw_about_us.php' || $current_page == 'add-about-us-option.php' || $current_page == 'delete_sw_about_us.php.php' || $current_page == 'edit_sw_about_us.php.php') {
                    ...
                    <div>
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                <a href="admin_all_sw_about_us.php">All About us Options</a>
                ...
                <li class="ic-eve">
                    ...
                    <a href="#"
                        ...
                        class="<?php if ($current_page == 'admin_all_travel_distance.php' || $current_page == 'add_travel_distance.php' || $current_page == 'edit_travel_distance.php' || $current_page == 'delete_sw_travel_distance.php') {

                            echo 'mact';

                        } ?>">Travel Distance Options</a>
                    ...
                    <div>
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                <a href="admin_all_travel_distance.php">All Travel Distance Options</a>
                ...
                <li class="ic-eve">
                    ...
                    <a href="#"
                        ...
                        class="<?php if ($current_page == 'admin_all_sw_languages.php' || $current_page == 'add_sw_lang.php' || $current_page == 'edit_sw_language.php.php' || $current_page == 'delete_sw_language.php') {
                    ...
                    <div>
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                <a href="admin_all_sw_languages.php">All Language Options</a>
                ...
                <li class="ic-eve">
                    ...
                    <a href="#"
                        ...
                        class="<?php if ($current_page == 'admin_all_avail_time.php' || $current_page == 'add_avail_time.php' || $current_page == 'edit_avail_time.php' || $current_page == 'delete_avail_time.php') {

                            echo 'mact';

                        } ?>">Availability Time Options</a>
                    ...
                    <div>
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                <a href="admin_all_avail_time.php">All Availability Time Options</a>
                ...
                <li class="ic-eve">
                    ...
                    <a href="#"
                        ...
                        class="<?php if ($current_page == 'admin_all_pet_frie.php' || $current_page == 'add_pet_friendl.php'  || $current_page == 'delete_pet_frien.php'  || $current_page == 'edit_pet_frien.php') {

                            echo 'mact';

                        } ?>">Pet friendly Options</a>
                    ...
                    <div>
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                <a href="admin_all_pet_frie.php">Pet friendly Options</a>
                ...
                <li class="ic-eve">
                    ...
                    <a href="#"
                        ...
                        class="<?php if ($current_page == 'admin_all_supp_prefrence.php' || $current_page == 'add_supp_prefrence.php' || $current_page == 'delete_supp_prefrence.php' || $current_page == 'edit_supp_prefrence.php') {

                            echo 'mact';

                        } ?>">Support Preference Options</a>
                    ...
                    <div>
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                <a href="admin_all_supp_prefrence.php">Support Preference Options</a>
                ...
                <li class="ic-eve">
                    ...
                    <a href="#"
                        ...
                        class="<?php if ($current_page == 'admin_all_plan_manage.php' || $current_page == 'add_plan_manage.php.php' || $current_page == 'delete_plan_manage.php.php' || $current_page == 'add_plan_manage.php') {

                            echo 'mact';

                        } ?>">Plan Manage Options</a>
                    ...
                    <div>
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                <a href="admin_all_plan_manage.php">All Plan Manage Options</a>
                ...
                <li class="ic-eve">
                    ...
                    <a href="#"
                        ...
                        class="<?php if ($current_page == 'admin-all-parti-identify.php' || $current_page == 'add-part-identify.php' || $current_page == 'edit-part-identify.php' || $current_page == 'delete-part-identify.php') {

                            echo 'mact';

                        } ?>">Participant Identify Options</a>
                    ...
                    <div>
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                <a href="admin-all-parti-identify.php">All Participant Identify Options</a>
                ...
                <li class="ic-eve">
                    ...
                    <a href="#"
                        ...
                        class="<?php if ($current_page == 'admin-all-rel-with-partici.php' || $current_page == 'admin_add_support_offer.php' || $current_page == 'admin-support-offer-edit.php' || $current_page == 'admin-delete-sup_offers.php') {

                            echo 'mact';

                        } ?>">Rel participant Options</a>
                    ...
                    <div>
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                <a href="admin-all-rel-with-partici.php">All Rel participant Options</a>
                ...
                <li class="ic-eve">
                    ...
                    <a href="#" class="<?php if ($current_page == 'admin-all-age-range.php' || $current_page == 'admin_add_support_offer.php' || $current_page == 'admin-support-offer-edit.php' || $current_page == 'admin-delete-sup_offers.php') {
                    ...
                    <div>
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                <a href="admin-all-age-range.php">All Age Range Options</a>
