                ...
                <div class="container">
                    <div class="row">
                        <div class="login-main add-list add-ncate">
                            ...
                            <span class="udb-inst">New Service Provider Sub Category</span>
                            <div class="log log-1">
                                <div class="login">
                                    <h4>Add New Service Provider Sub Category</h4>
                                    <?php include "../page_level_message.php"; ?>
                                    <span class="add-list-add-btn scat-add-btn" data-toggle="tooltip"
                                    ...
                                    <form name="sub_category_form" id="sub_category_form" method="post"
                                        action="insert_ser_pro_subcategory.php" enctype="multipart/form-data"
                                    ...
                                    <div class="col-md-12">
                                        <a href="admin-all-sub-category.php" class="skip">Go to All Listing Sub Category
                                            >></a>
                                    </div>
