                ...
                <div class="container">
                    <div class="row">
                        <div class="login-main add-list add-ncate">
                            ...
                            <span class="udb-inst">Delete this Range Option</span>
                            <div class="log log-1">
                                <div class="login">
                                    <h4>Delete this Range Option</h4>
                                    <?php include "../page_level_message.php"; ?>
                                    <?php
                                    $rangeid = $_GET['row'];
                                    $range_a_row = getRange($rangeid);
                                    ?>
                                    <form action="trash-age-range.php" class="range_form" id="range_form" name="range_form"
                                        ...
                                        <div class="inn">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="range" id="range"
                                                                       class="form-control" required value="<?php echo $range_a_row['age_range_name']; ?>" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="range_max" id="age_range"
                                                                       class="form-control" required value="<?php echo $range_a_row['range_max']; ?>" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="range_min" id="age_range"
                                                                       class="form-control" required value="<?php echo $range_a_row['range_min']; ?>" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                            ...
                                            <div class="form-group">
                                                <button type="submit" name="range_submit" class="btn btn-primary">Delete
                                                    Now
                                                </button>
                                            </div>
                                        </div>
