                ...
                <div class="ud-cen-s2">
                    ...
                    <table class="responsive-table bordered" id="pg-resu">
                        ...
                        foreach (getAllUser() as $row) {
                            ...
                            <tr>
                                <td><?php echo $si; ?></td>
                                <td><img src="../images/user/<?php if(($row['profile_image'] == NULL) || empty($row['profile_image'])){  echo $footer_row['user_default_image'];}else{ echo $row['profile_image']; } ?>" alt="" loading="lazy"><?php echo $row['first_name']; ?><span><?php echo $row['email_id']; ?></span><span>Join:<?php echo dateFormatconverter($row['user_cdt']); ?></span>
                                </td>
