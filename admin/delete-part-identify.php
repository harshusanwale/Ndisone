                ...
                <div class="container">
                    <div class="row">
                        <div class="login-main add-list add-ncate">
                            ...
                            <span class="udb-inst">Delete this Participant Identify Option</span>
                            <div class="log log-1">
                                <div class="login">
                                    <h4>Delete this Participant Identify Option</h4>
                                    <?php include "../page_level_message.php"; ?>
                                    <?php
                                    $partideid = $_GET['row'];
                                    $paidenid_a_row = getPartIdenti($partideid);
                                    ?>
                                    <form action="trash-par-identify.php" class="part_identi_form" id="part_identi_form" name="part_identi_form"
                                        ...
                                        <div class="inn">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="part_ident" id="part_ident"
                                                                       class="form-control" required value="<?php echo $paidenid_a_row['pa_identify_as_name']; ?>" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                            ...
                                            <div class="form-group">
                                                <button type="submit" name="partidenti_submit" class="btn btn-primary">Delete
                                                    Now
                                                </button>
                                            </div>
                                        </div>
