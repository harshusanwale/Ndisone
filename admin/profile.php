                    ...
                    <div class="chart-tit">
                        ...
                        <div class="rhs">
                            <ul>
                                ...
                                ?>
                                <li><span>Total earning: <b><?php  echo $footer_row['currency_symbol']; ?><?php echo AddingZero_BeforeNumber($all_total_payment_sum); ?></b></span></li>
                                <li><span>Last 30 days earning: <b><?php  echo $footer_row['currency_symbol']; ?><?php echo AddingZero_BeforeNumber($all_30_payment_sum); ?></b></span></li>
                            </ul>
                        </div>
                    </div>
