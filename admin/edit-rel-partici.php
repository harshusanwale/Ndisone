                ...
                <div class="container">
                    <div class="row">
                        <div class="login-main add-list add-ncate">
                            ...
                            <span class="udb-inst">Edit this Rel participant Option</span>
                            <div class="log log-1">
                                <div class="login">
                                    <h4>Edit this Rel participant Option</h4>
                                    <?php include "../page_level_message.php"; ?>
                                    <?php
                                    $relpartid = $_GET['row'];
                                    $relpart_a_row = getRelParti($relpartid);
                                    ?>
                                    <form action="update-rel-parti.php" class="rel_parti_form" id="rel_parti_form" name="rel_parti_form"
                                        ...
                                        <div class="inn">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="rel_parti" id="rel_parti"
                                                                       class="form-control" required value="<?php echo $relpart_a_row['relation_wi_par_name']; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                            ...
                                            <div class="form-group">
                                                <button type="submit" name="rel_parti_submit" class="btn btn-primary">Update
                                                    Now
                                                </button>
                                            </div>
                                        </div>
