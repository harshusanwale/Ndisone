		...
		<div class="container">
			<div class="row">
                <div class="login-main add-list add-ncate">
                    ...
                    <span class="udb-inst">Edit SERVICE PROVIDER CATEGORY</span>
                    <div class="log log-1">
                        <div class="login">
                            <h4>Edit this SERVICE PROVIDER CATEGORY</h4>
                            <?php include "../page_level_message.php"; ?>
                            <?php
                            $category_id=$_GET['row'];
                            $row= getProCategory($category_id);
                            ?>
                             <form name="category_form" id="category_form" method="post" action="update_ser_pro_category.php" enctype="multipart/form-data" class="cre-dup-form cre-dup-form-show">
                                 <input type="hidden" class="validate" id="category_id" name="category_id" value="<?php echo $row['id']; ?>" required="required">
                                 <ul>
                                     <li>
                                        <div class="row">
                                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                    <a href="admin-ser-pro-category.php" class="skip">Go to All Provider Category >></a>
                                </div>
                            <!-- <div class="ud-notes">
