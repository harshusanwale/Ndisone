                ...
                <div class="container">
                    <div class="row">
                        <div class="login-main add-list add-ncate">
                            ...
                            <span class="udb-inst">Edit this Plan Manage Option</span>
                            <div class="log log-1">
                                <div class="login">
                                    <h4>Edit this Plan Manage Option</h4>
                                    <?php include "../page_level_message.php"; ?>
                                    <?php
                                    $planid = $_GET['row'];
                                    $plan_a_row = getPlanManage($planid);
                                    ?>
                                    <form action="update_plan_manage.php" class="plan_manage_form" id="plan_manage_form" name="plan_manage_form"
                                        ...
                                        <div class="inn">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="plan_name" id="plan_name"
                                                                       class="form-control" required value="<?php echo $plan_a_row['plan_man_name']; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                            ...
                                            <div class="form-group">
                                                <button type="submit" name="plan_submit" class="btn btn-primary">Update
                                                    Now
                                                </button>
                                            </div>
                                        </div>
