        ...
        <div class="ad-menu">
            <ul>
                ...
                if ($footer_row['admin_listing_show'] == 1) {
                    ...
                    <li class="ic-poi">
                        <a href="#"
                           class="<?php if ($current_page == 'admin-all-regis-group.php' || $current_page == 'admin-add-new-group.php' ) {
                               echo 'mact';
                           } ?>">Registration Group</a>
                        <div>
                            <ol>
                                <li>
                                    <a href="admin-all-regis-group.php">All Registration Group</a>
                                </li>
                                <li>
                                    <a href="admin-add-new-group.php">Create New Registration Group</a>
                                </li>
                            </ol>
                        </div>
                    </li>
