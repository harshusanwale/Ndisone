		...
		<div class="container">
			<div class="row">
                <div class="login-main add-list add-ncate">
                    ...
                    <span class="udb-inst">Delete Registration Group</span>
                    <div class="log log-1">
                        <div class="login">
                            <h4>Delete Registration Group</h4>
                            <?php include "../page_level_message.php"; ?>
                            <?php
                            $reg_group_id = $_GET['row'];
                            $reg_group_a_row = getRegGroup($reg_group_id);
                            ?>
                             <form name="reg_group_form" id="reg_group_form" method="post" action="trash_reg_group.php" class="cre-dup-form cre-dup-form-show" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group"> 
                                                  <input type="text" id="group_name" name="group_name" class="form-control" placeholder="Registration Group name *" required value="<?php echo $reg_group_a_row['name'] ?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                     </li>
