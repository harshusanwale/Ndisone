...
//************ Category Name Already Exist Check Starts ***************
        ...
        $sub_category_name_exist_check = mysqli_query($conn, "SELECT * FROM " . TBL . "service_provider_sub_categories  WHERE sub_category_name='" . $sub_category_name . "' AND id != $sub_category_id ");
        if (mysqli_num_rows($sub_category_name_exist_check) > 0) {
            ...
            header('Location: edit-ser-pro-subcategory.php?row=' . $sub_category_id);
            exit;
...
//************ Category Name Already Exist Check Ends ***************
        ...
        $sql = mysqli_query($conn, "UPDATE  " . TBL . "service_provider_sub_categories SET sub_category_name='" . $sub_category_name . "'
     , category_id='" . $category_id . "', sub_category_udt='" . $curDate . "'
