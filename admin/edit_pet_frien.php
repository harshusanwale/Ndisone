                ...
                <div class="container">
                    <div class="row">
                        <div class="login-main add-list add-ncate">
                            ...
                            <span class="udb-inst">Edit this Availability time Option</span>
                            <div class="log log-1">
                                <div class="login">
                                    <h4>Edit this Availability time Option</h4>
                                    <?php include "../page_level_message.php"; ?>
                                    <?php
                                    $petfriid = $_GET['row'];
                                    $petfri_a_row = getPetFri($petfriid);
                                    ?>
                                    <form action="update_pet_frien.php" class="pet_friendly_form" id="pet_friendly_form" name="pet_friendly_form"
                                        ...
                                        <div class="inn">
                                            ...
                                            <div class="form-group">
                                                <button type="submit" name="pet_fri_submit" class="btn btn-primary">Update
                                                    Now
                                                </button>
                                            </div>
                                        </div>
