...
//************ sub_category Name Already Exist Check Starts ***************
        ...
        $sub_category_name_exist_check = mysqli_query($conn, "SELECT * FROM " . TBL . "service_provider_sub_categories  WHERE sub_category_name='" . $sub_category_name . "' ");
        ...
        if (mysqli_num_rows($sub_category_name_exist_check) > 0) {
            ...
            header('Location: add-ser-pro-subcategory.php');
            exit;
...
//        }
    ...
    // }
        ...
        $sql = mysqli_query($conn, "INSERT INTO  " . TBL . "service_provider_sub_categories (sub_category_name,category_id,sub_category_cdt,sub_category_udt)
VALUES ('$sub_category_name','$category_id','$curDate','$curDate')");
        ...
        $upqry = mysqli_query($conn, "UPDATE " . TBL . "service_provider_sub_categories
    ...
    if ($upqry) {
        ...
        header('Location: admin-ser-pro-subcategory.php');
        exit;
