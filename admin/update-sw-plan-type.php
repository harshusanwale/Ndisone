...
//        }
    ...
    $sql = mysqli_query($conn,"UPDATE  " . TBL . "sw_plan_type SET plan_type_name='" . $plan_type_name . "', plan_type_price='" . $plan_type_price. "'
     ...
     where id='" . $plan_type_id . "'");
        ...
        if ($sql) {
            ...
            header('Location: sw-plans-edit.php?row=' . $plan_type_id);
            exit;
        }
