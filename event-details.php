    ...
    <div class="container">
        <div class="eve-deta-pg-main">
            ...
            ?>
             <div class="lhs">
                <div class="img">
                    <img src="<?php echo $slash; ?>images/events/<?php echo $events_a_row['event_image']; ?>" alt="" loading="lazy">
                                ...
                                <div class="eve-box">
                                    <div>
                                        <a href="<?php echo $EVENT_URL.urlModifier($eventrow['event_slug']); ?>">
                                            <img src="<?php echo $slash; ?>images/events/<?php echo $eventrow['event_image']; ?>" alt="" loading="lazy">
