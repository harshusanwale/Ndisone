...
if (!isset($_COOKIE['user_id'])) {
    ...
    if (mysqli_num_rows($login) > 0) {
        ...
        $profile_image = $login_row['profile_image'];
                    ...
                    <div class="login login-new">
                        ...
                        <form name="register_form" id="register_form" method="post" action="register_update_sw_profile_details_form.php" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="image">
                                            <img id="imagePreview"  src="images/user/<?php echo $image; ?>" alt="" loading="lazy" height="200px" width="200px">
                                        </label>
                                    </div>
                                    <div class="form-group">
                                    <input type="file" id="image" feild="imagePreview" autocomplete="off" name="profile_image" id="profile_image" class="form-control colorBackground" placeholder="Upload Photo/ Emoji" onchange="previewImage(event)" >
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="Date" autocomplete="off" name="birth_year" id="birth_year" class="form-control colorBackground" placeholder="Date of Birth" onchange="calculateAge()">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" autocomplete="off" name="user_city" id="user_city" class="form-control red_message" placeholder="City" >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" autocomplete="off" name="user_state" id="user_state" class="form-control red_message" placeholder="State" >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" autocomplete="off" name="user_country" id="user_country" class="form-control red_message" placeholder="Country" >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" autocomplete="off" name="user_zip_code" id="user_zip_code" class="form-control red_message" placeholder="Postcode" >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" autocomplete="off" name="user_latitude" id="user_latitude" class="form-control red_message" placeholder="Postcode" >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" autocomplete="off" name="user_longitude" id="user_longitude" class="form-control red_message" placeholder="Postcode" >
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" autocomplete="off" name="location" id="location" class="form-control colorBackground" placeholder="Based in /Location" >
                                    </div>
                                </div>
                                ...
                                <ul>
                                    <li>
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <input type="date" autocomplete="off" name="workexp[0][work_from]" id="work_from0" class="form-control colorBackground" placeholder="From" oninput="calculateDateDifference(0)" >
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <input type="date" autocomplete="off" name="workexp[0][work_to]" id="work_to0" class="form-control colorBackground" placeholder="To" oninput="calculateDateDifference(0)" >
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
