                        ...
                        <div class="login-main add-list add-ncate">
                            ...
                            <div class="log log-1">
                                <div class="login">
                                    ...
                                    ?>
                                    <form action="trash_avail_time.php" class="avail_time_form" id="avail_time_form" name="avail_time_form"
                                        ...
                                        <div class="inn">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="avail_time" id="avail_time"
                                                                       class="form-control" required value="<?php echo $availtime_a_row['avail_time_name']; ?>" readonly="readonly">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                            ...
                                            <div class="form-group">
                                                <button type="submit" name="avail_time_submit" class="btn btn-primary">Delete
                                                    Now
                                                </button>
                                            </div>
                                        </div>
