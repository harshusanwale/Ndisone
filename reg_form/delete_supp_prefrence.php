                ...
                <div class="container">
                    <div class="row">
                        <div class="login-main add-list add-ncate">
                            ...
                            <span class="udb-inst">Delete this Support Preference Option</span>
                            <div class="log log-1">
                                <div class="login">
                                    <h4>Delete this Support Preference Option</h4>
                                    <?php include "../page_level_message.php"; ?>
                                    <?php
                                    $supppreid = $_GET['row'];
                                    $supppre_a_row = getSuppPre($supppreid);
                                    ?>
                                    <form action="trash_supp_prefrence.php" class="supp_prefrence_form" id="supp_prefrence_form" name="supp_prefrence_form"
                                        ...
                                        <div class="inn">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="supp_pref" id="supp_pref"
                                                                       class="form-control" required value="<?php echo $supppre_a_row['support_prefer_name']; ?>" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                            ...
                                            <div class="form-group">
                                                <button type="submit" name="supp_pref_submit" class="btn btn-primary">Delete
                                                    Now
                                                </button>
                                            </div>
                                        </div>
