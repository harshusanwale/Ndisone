...
<title>
    ...
    if ($current_page == "listing-details.php") {
        ...
        if (!empty($seo_details_row['seo_page_title']) || $seo_details_row['seo_page_title'] != NULL) {
            echo $seo_details_row['seo_page_title'];
	 //echo str_replace("BizBook Directory Template by Rn53Themes.net","11National Disability Information Services",$seo_details_row['seo_page_title']);
        } else {
            echo $footer_row['admin_seo_title'];
        }
...
<?php 
echo " | One place to find all your NDIS services";
?>
</title>
<!--== META TAGS ==-->
<meta charset="utf-8">
