                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="hot-page2-hom-pre-1">
                                        <img src="<?php echo $slash; ?>service-experts/images/services/<?php echo $except_list_row['profile_image']; ?>" alt="" loading="lazy">
                                    </div>
                        ...
                        <div class="hot-page2-hom-pre">
                            ...
                            <ul>
                                ...
                                foreach (getExceptAllExpertCategories($expert_profile_category_id) as $except_category_row) {
                                    ...
                                    <li>
                                        <div class="hot-page2-hom-pre-1">
                                            <img src="<?php echo $slash; ?>service-experts/images/services/<?php echo $except_category_row['category_image']; ?>" alt="" loading="lazy">
                                        </div>
                                        <div class="hot-page2-hom-pre-2">
