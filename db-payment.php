                ...
                <div class="ud-payment">
                    ...
                    <div class="pay-rhs">
                        ...
                        <ul>
                            ...
                            <li><span class="ud-stat-pay-btn"><?php echo $BIZBOOK['DASH_RIGHT_CHECKOUT_AMOUNT'];  ?>: <?php if ($user_plan_type['plan_type_price'] == 0) {
                                                                                                                           ...
                                                                                                                           if (isset($_SESSION['custom_plan_price']) && !empty($_SESSION['custom_plan_price'])) {
                                                                                                                            echo $footer_row['currency_symbol'] . '' . $_SESSION['custom_plan_price'];
                                                                                                                            unset($_SESSION['custom_plan_price']);
                                                                                                                           }
                                                                                                                           else
                                                                                                                           {
                                                                                                                            echo $footer_row['currency_symbol'] . '' . $user_plan_type['plan_type_price'];
                            ...
                            <li><span class="ud-stat-pay-btn"><?php echo $BIZBOOK['DASH_RIGHT_PAYMENT_STATUS'];  ?>: <?php if ($user_details_row['payment_status'] == 'Paid') {
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" readonly="readonly" value="<?php echo $user_details_row['first_name']; ?>" placeholder="<?php echo $BIZBOOK['FULL_NAME'];  ?> *" required>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="user_country" class="form-control" value="<?php echo $user_details_row['user_country']; ?>" placeholder="<?php echo $BIZBOOK['COUNTRY'];  ?>">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" readonly="readonly" class="form-control" value="<?php echo $user_details_row['first_name']; ?>" placeholder="<?php echo $BIZBOOK['FULL_NAME'];  ?> *" required>
