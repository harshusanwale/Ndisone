        ...
        <div class="row">
            <div class="add-list-ste">
                <div class="add-list-ste-inn">
                    <ul>
                        <li>
                            <a href="edit-listing-step-new-1">
                        ...
                        <li>
                            <a href="edit-listing-step-new-3">
                                <span><?php echo $BIZBOOK['STEP3']; ?></span>
                                <b>Locations</b>
                            </a>
                        </li>
                        <li>
                            <a href="edit-listing-step-new-4">
                                <span><?php echo $BIZBOOK['STEP4']; ?></span>
                                <b>>Work Hours</b>
                            </a>
                        </li>
                        <li>
                            <a href="edit-listing-step-new-5">
                                <span><?php echo $BIZBOOK['STEP5']; ?></span>
                                <b><?php echo $BIZBOOK['OTHER']; ?></b>
                            </a>
                        </li>
                        <li>
                            <a href="edit-listing-step-new-6" class="act">
