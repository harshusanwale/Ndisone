...
if (isset($_POST['register_submit'])) {
    ...
    onsuccess_create_session($_SESSION['verification_link'], $_SESSION['verification_code']);
                    ...
                    <div class="login login-new">
                        ...
                        <form name="login_participant" id="login_participant" method="post" action="login_participant.php">
                            ...
                            <div class="form-group ca-sh-plan_user_info" style="display:none">
                                <div class="row form-group">
                                    <div class="form-group col-sm-6">First Name
                                        <input style="background-color: #66ff99;" readonly type="text" autocomplete="off" name="d_first_name" id="d_first_name" class="form-control" placeholder="Enter First Name" value="<?php echo $first_name; ?>">
                                    </div>
                                    <div class="form-group col-sm-6">Last Name
                                        <input style="background-color: #66ff99;" readonly type="text" autocomplete="off" name="d_last_name" id="d_last_name" class="form-control" placeholder="Enter Last Name" value="<?php echo $last_name; ?>">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="form-group col-sm-6">Email Address
                                        <input style="background-color: #66ff99;" readonly type="text" autocomplete="off" name="d_email_id" id="d_email_id" class="form-control" placeholder="<?php echo $BIZBOOK['EMAIL_ID_STAR']; ?>" value="<?php echo $email_id; ?>">
                                    </div>
                                    <div class="form-group col-sm-6">Mobile Number
                                        <input style="background-color: #66ff99;" readonly type="text" autocomplete="off" name="d_mobile_number" id="d_mobile_number" class="form-control" placeholder="<?php echo $BIZBOOK['PHONE']; ?>" value="<?php echo $mobile_number; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row form-group">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="form-group col-sm-6 class_p_age_range" >Participant Age Range
                            ...
                            <div class="row form-group">
                                <div class="form-group col-sm-6">
                                    <button type="submit" name="register_submit" class="btn btn_1 btn-primary"><?php echo "Enter"; ?></button>
                                </div>
                                <div class="form-group col-sm-6">
...
<script>
    $(document).ready(function() {
        var background_color_green = '#66ff99';
...
$('#p_first_name').on('propertychange input', function (e) {
...
$('#p_last_name').on('propertychange input', function (e) {
    var valueChanged = false;
...
//17-7-2023            
            $('#n_p_managed').attr('required', 'required');
                        $('#n_p_managed').prop('selectedIndex', 0);
                        $('#n_p_managed').css("background-color", "white");
            $('#service_location').attr('required', 'required');
                        $('#service_location').val('');
                        $('#service_location').css("background-color", "white");
            $('#p_contact_method').attr('required', 'required');
                        $('#p_contact_method').prop('selectedIndex', 0);
                        $('#p_contact_method').css("background-color", "white");
            $('#p_identify_as').attr('required', 'required');
                        $('#p_identify_as').prop('selectedIndex', 0);
                        $('#p_identify_as').css("background-color", "white");
            $('#language_spoken').attr('required', 'required');
                        $('#language_spoken').val('');
                        $('#language_spoken').css("background-color", "white");
            $('#interpreter_r').attr('required', 'required');
                        $('#interpreter_r').prop('selectedIndex', 0);
                        $('#interpreter_r').css("background-color", "white");
            $('#ndis_number').attr('required', 'required');
                        $('#ndis_number').val('');
                        $('#ndis_number').css("background-color", "white");
            $('#p_age_range').attr('required', 'required');
                        $('#p_age_range').prop('selectedIndex', 0);
                        $('#p_age_range').css("background-color", "white");
//17-7-2023            
...
//17-7-2023   kkkkkkkkkkkkkkkkkkkkkkkkkkk         
$('#n_p_managed').attr('required', 'required');
                        $('#n_p_managed').prop('selectedIndex', 0);
                        $('#n_p_managed').css("background-color", "white");
            $('#service_location').attr('required', 'required');
