                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <!-- <input type="date" autocomplete="off" name="birth_year" id="birth_year" class="form-control colorBackground" placeholder="Date of Birth" onchange="calculateAge()" min="1900-01" max="2099-12"> -->
