            ...
            <div class="add-list-ste">
                <div class="add-list-ste-inn">
                    ...
                    <li>
                        ...
                        <li>
                            <a href="edit-listing-step-new-7?row=<?php echo $listing_codea; ?>"  class="act">
                ...
                <div class="log">
                    <div class="login add-lis-oth">
                        ...
                        <form action="listing_update_new.php" class="listing_form_5" id="listing_form_5"
                            ...
                            <input type="hidden" id="src_path" value="edit-7"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select  multiple name="language" id="language" class="form-control colorBackground ca-check-plan chosen-select" >
                                        <option value="">--Select--</option>
