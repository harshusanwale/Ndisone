...
<div class="ud-lhs">
   ...
   <div class="ud-lhs-s2">
      <ul>
         ...
         <?php
        if ($user_details_row['user_type'] == "Support coordinator") {  //To Check User type is Service provider                        
            ?>
        ...
        if ($user_details_row['user_type'] == "Service provider") {  //To Check User type is Service provider                        
         ...
         <li>
            <a href="transaction_history"  class="<?php if ($current_page == "transaction_history.php") {
               echo "db-lact";              
               
               
               } ?>"><img src="<?php echo $slash; ?>images/icon/dbl9.png"
               alt=""/><?php echo 'Transaction History'; ?></a>
         </li>
