...
<span class="btn-ser-need-ani"><img src="<?php echo $slash; ?>images/icon/help.png" alt="" loading="lazy"></span>
    ...
    <div class="container">
        ...
        <div class="row wed-foot-link-1">
            ...
            <div class="col-md-4 fot-app">
                ...
                <ul>
                    <li><a href="<?php echo $footer_row['mobile_app_andriod']; ?>"><img src="<?php echo $slash; ?>images/gstore.png" alt="" loading="lazy"></a>
                    </li>
                    <li><a href="<?php echo $footer_row['mobile_app_ios']; ?>"><img src="<?php echo $slash; ?>images/astore.png" alt="" loading="lazy"></a>
                    </li>
                </ul>
            </div>
            <?php } ?>
            <div class="col-md-4 fot-soc">
                ...
                <ul>
                    <li><a target="_blank" href="<?php echo $footer_row['footer_linked_in']; ?>"><img src="<?php echo $slash; ?>images/social/1.png" alt="" loading="lazy"></a></li>
                    <li><a target="_blank" href="<?php echo $footer_row['footer_twitter']; ?>"><img src="<?php echo $slash; ?>images/social/2.png" alt="" loading="lazy"></a></li>
                    <li><a target="_blank" href="<?php echo $footer_row['footer_fb']; ?>"><img src="<?php echo $slash; ?>images/social/3.png" alt="" loading="lazy"></a></li>
                    <li><a target="_blank" href="<?php echo $footer_row['footer_whatsapp']; ?>"><img src="<?php echo $slash; ?>images/social/4.png" alt="" loading="lazy"></a></li>
                    <li><a target="_blank" href="<?php echo $footer_row['footer_youtube']; ?>"><img src="<?php echo $slash; ?>images/social/5.png" alt="" loading="lazy"></a></li>
                </ul>
            </div>
        </div>
