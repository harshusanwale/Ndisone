            ...
            <div class="login-main">
                ...
                <div class="log log-1">
                    <div class="login login-new">
                        ...
                        <form name="register_update_next_form" id="register_update_next_form" method="post" action="register_update_next_form.php">
                            ...
                            <button type="submit" name="register_sw_next_submit" class="btn btn-primary">Next</button>
                        </form>
                    </div>
                </div>
            </div>
