            ...
            <div class="container">
                ...
                <div class="hom-mpop-main">
                    ...
                    <div class="home-tit">
                        ...
                        <h2><span><?php //echo $BIZBOOK['HOM-BEST-TIT'];
                                    ?></span>
                ...
                <div class="hlead-coll">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="hom-cre-acc-left">
                            ...
                            <h3><?php // echo $BIZBOOK['HOM-WHAT-SER'];
                                ...
                                <span><?php //echo $BIZBOOK['HOM-WHAT-BIZ'];
                                        ?></span>

                            </h3>

                            <p><?php //echo $BIZBOOK['HOM-WHAT-SUB-HEAD'];
                                ?></p>

                            <ul>

                                <li><img src="images/icon/blog.png" alt="" loading="lazy">

                                    <div>

                                        <h5><?php // echo $BIZBOOK['HOM-WHAT-SER-PO1'];
                                            ?></h5>

                                        <p><?php // echo $BIZBOOK['HOM-WHAT-SER-PO1-SUB'];
                                            ?></p>
                                ...
                                <li><img src="images/icon/shield.png" alt="" loading="lazy">

                                    <div>

                                        <h5><?php //echo $BIZBOOK['HOM-WHAT-SER-PO2'];
                                            ?></h5>

                                        <p><?php //echo $BIZBOOK['HOM-WHAT-SER-PO2-SUB'];
                                            ?></p>
                                ...
                                <li><img src="images/icon/general.png" alt="" loading="lazy">

                                    <div>

                                        <h5><?php // echo $BIZBOOK['HOM-WHAT-SER-PO3'];
                                            ?></h5>

                                        <p><?php // echo $BIZBOOK['HOM-WHAT-SER-PO3-SUB'];
                                            ?></p>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="hom-col-req">
                            ...
                            <span class="udb-inst"><?php //echo $BIZBOOK['LEAD-FILL-THE-FORM'];
                                                    ?></span>

                            <h4><?php //echo $BIZBOOK['HOM-WHT-LOOK-TIT'];
                                ?></h4>
                            ...
                            <div id="home_enq_success" class="log"
                                ...
                                <p><?php //echo $BIZBOOK['ENQUIRY_SUCCESSFUL_MESSAGE'];
                                    ?></p>
                            ...
                            <div id="home_enq_fail" class="log" style="display: none;">
                                ...
                                <p><?php // echo $BIZBOOK['OOPS_SOMETHING_WENT_WRONG'];
                                    ?></p>
                            ...
                            <div id="home_enq_same" class="log" style="display: none;">
                                ...
                                <p><?php //echo $BIZBOOK['ENQUIRY_OWN_LISTING_MESSAGE'];
                                    ?></p>
                            ...
                            <form name="home_enquiry_form" id="home_enquiry_form" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="enquiry_category" id="enquiry_category" class="form-control">
                                        ...
                                        <option value=""><?php // echo $BIZBOOK['SELECT_CATEGORY'];
                                                            ?></option>
                        ...
                        <textarea class="form-control" rows="3" name="enquiry_message"
                                  ...
                                  placeholder="<?php //echo $BIZBOOK['LEAD-MESSAGE-PLACEHOLDER'];
                                                ?>"></textarea>
                ...
                <div class="row">
                    ...
                    <div class="home-tit">
                        ...
                        <h2>
                            ...
                            <span><?php //echo $BIZBOOK['HOM-TOPSER-TIT'];
                                    ?></span> <?php //echo $BIZBOOK['HOM-TOPSER-TIT1'];
                                                                                        ?>

                        </h2>

                        <p><?php //echo $BIZBOOK['HOM-TOPSER-SUB-TIT'];
                            ?></p>
                                ...
                                <li>
                                    ...
                                    <div class="plac-hom-box">
                                        ...
                                        <div class="plac-hom-box-im">
                                            ...
                                            <img src="images/products/start-selling.jpg" alt="" loading="lazy">
                                ...
                                <li>
                                    ...
                                    <div class="plac-hom-box">
                                        ...
                                        <div class="plac-hom-box-im">
                                            ...
                                            <img src="images/coupon-deals.jpg" alt="" loading="lazy">
                                    ...
                                    <div class="plac-hom-box">
                                        ...
                                        <div class="plac-hom-box-im">
                                            ...
                                            <div class="inn-text">
                                                ...
                                                <a href="places/">Explore travel <i class="material-icons">arrow_forward</i></a>
                                    ...
                                    <div class="plac-hom-box">
                                        ...
                                        <div class="plac-hom-box-im">
                                            ...
                                            <div class="inn-text">
                                                ...
                                                <a href="news/">News & Magazines <i class="material-icons">arrow_forward</i></a>
                            ...
                            <li>
                                ...
                                <div class="pri-box">
                                    ...
                                    <div class="c5">
                                        ...
                                        <a href="pricing-details" class="cta2" target="_blank"><?php echo $BIZBOOK['HOM-VI-KNOW-MORE']; ?></a>
                    ...
                    <?php if ($footer_row['admin_mobile_app_feature'] == 1) { ?>
                        ...
                        <div class="mob-app">
                            ...
                            <div class="rhs">
                                ...
                                <a href="#"><img src="images/gstore.png" alt="" loading="lazy"> </a>

                                <a href="#"><img src="images/astore.png" alt="" loading="lazy"> </a>
                                ...
                                <li>
                                    ...
                                    <div class="plac-hom-box">
                                        ...
                                        <div class="plac-hom-box-im">
                                            ...
                                            <img src="<?php echo $slash; ?>service-experts/images/services/<?php echo $expert_categories_row['category_image']; ?>" alt="" loading="lazy">
                ...
                <div class="row">
                    ...
                    <div class="plac-hom-tit plac-hom-tit-ic-nws">
                        ...
                        <p><?php echo $BIZBOOK['NEWS-HOMEPAGE-BANNER-P-TEXT']; ?>
                            ...
                            <b><?php echo $BIZBOOK['PLACE-NEWS-B']; ?></b>
                        </p>
                                ...
                                <li>
                                    ...
                                    <div class="plac-hom-box">
                                        ...
                                        <div class="plac-hom-box-im">
                                            ...
                                            <img src="<?php echo $slash; ?>news/images/news/<?php echo $home_page_slider_news_sql_row['news_image']; ?>" alt="" loading="lazy">
                                ...
                                <li>
                                    ...
                                    <div class="plac-hom-box">
                                        ...
                                        <div class="plac-hom-box-im">
                                            ...
                                            <img src="<?php echo $slash; ?>places/images/places/<?php echo explode(',', $placerow['place_gallery_image'])[0]; ?>" alt="" loading="lazy">
                                ...
                                <li>
                                    ...
                                    <div class="land-pack-grid">
                                        ...
                                        <div class="land-pack-grid-img">
                                            ...
                                            <img src="<?php echo $webpage_full_link; ?>images/services/<?php echo $category_sql_row['category_image']; ?>" alt="" loading="lazy">

                                        </div>

                                        <div class="land-pack-grid-text">

                                            <h4>2323<?php echo $category_sql_row['category_name']; ?>
                            ...
                            ?>
                                ...
                                <li>
                                    ...
                                    <div class="testmo hom4-prop-box">
                                        ...
                                        <img src="<?php echo $webpage_full_link; ?><?php if ($listing_sql_row['profile_image'] != NULL || !empty($listing_sql_row['profile_image'])) {
                    ...
                    <li>
                        ...
                        <div class="news-hban-box">
                            ...
                            <div class="im">
                                ...
                                <img src="<?php echo $webpage_full_link; ?>images/events/<?php echo $event_sql_row['event_image']; ?>" alt="" loading="lazy">
                            ...
                            ?>
                                ...
                                <li>
                                    ...
                                    <div class="testmo">
                                        ...
                                        <img src="<?php echo $webpage_full_link; ?>images/user/<?php if (($user_details_row['profile_image'] == NULL) || empty($user_details_row['profile_image'])) {
                                        ...
                                        <span><?php echo $BIZBOOK['SERVICE-EXPERT-WRITTEN-REVIEW-TO']; ?> <a href="<?php echo $LISTING_URL . urlModifier($listing_sql_row['listing_slug']); ?>"><?php echo $listing_sql_row['listing_name']; ?></a></span>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div>
                                        ...
                                        <img src="<?php echo $webpage_full_link; ?>images/icon/how1.png" alt="" loading="lazy">
                                ...
                                <li>
                                    ...
                                    <div>
                                        ...
                                        <img src="<?php echo $webpage_full_link; ?>images/icon/how2.png" alt="" loading="lazy">
                                ...
                                <li>
                                    ...
                                    <div>
                                        ...
                                        <img src="<?php echo $webpage_full_link; ?>images/icon/how3.png" alt="" loading="lazy">
                                ...
                                <li>
                                    ...
                                    <div>
                                        ...
                                        <img src="<?php echo $webpage_full_link; ?>images/icon/how4.png" alt="" loading="lazy">
                    ...
                    <?php if ($footer_row['admin_mobile_app_feature'] == 1) { ?>
                        ...
                        <div class="mob-app">
                            ...
                            <div class="lhs">
                                ...
                                <img src="<?php echo $webpage_full_link; ?>images/mobile.png" alt="" loading="lazy">
                            ...
                            <div class="rhs">
                                ...
                                <a href="#"><img src="<?php echo $webpage_full_link; ?>images/android.png" alt="" loading="lazy"> </a>

                                <a href="#"><img src="<?php echo $webpage_full_link; ?>images/apple.png" alt="" loading="lazy"> </a>
