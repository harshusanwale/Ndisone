$(document).ready(function () {
 ...
 setTimeout(function () {
         $('.status_message, .log-suc, .log-fal').fadeOut();
     }, 3000);
    ...
    $(".location-add-btn").on('click', function () {
  ...
  google.maps.event.addDomListener(window, "load", initAutocomplete);
    ...
    $(".lis-wor-his-add-btn").on('click', function () {
        var len = $(".add-list-ser ul li").length;

        // Create the new list item with input fields and append it to the unordered list
        $(".add-list-ser ul li:last-child").after('<li><div class="row"><div class="col-md-6"><div class="form-group">Position<input type="text" autocomplete="off" name="workexp['+len+'][position]" id="position" class="form-control  custom-input colorBackground" placeholder="Position" required></div></div><div class="col-md-6"><div class="form-group">Companys name<input type="text" autocomplete="off" name="workexp['+len+'][company_name]" id="company_name" class="form-control custom-input colorBackground" placeholder="Company name" required></div></div><div class="col-md-3"><div class="form-group">Joining Date<input type="text" autocomplete="off" name="workexp['+len+'][work_from]" id="work_from'+len+'" class="form-control custom-input colorBackground" placeholder="YYYY-MM-DD" onchange="calculateDateDifference('+len+')" required></div></div><div class="col-md-3"><div class="form-group">Leaving Date<input type="text" autocomplete="off" name="workexp['+len+'][work_to]" id="work_to'+len+'" class="form-control custom-input colorBackground" placeholder="YYYY-MM-DD" onchange="calculateDateDifference('+len+')" required></div></div><div class="col-md-6"><div class="form-group">Total Experience<input type="text" autocomplete="off" name="workexp['+len+'][exp_year_month]" id="exp_year_month'+len+'" class="form-control custom-input colorBackground" placeholder="Year and month" required></div></div></div></li>');

        // Apply the event listener for background color changes to the new input fields
        applyBackgroundChangeListener();
    });

    // Function to apply the background color change event listener to all input fields
    // function applyBackgroundChangeListener() {
    //     $(".colorBackground").each(function () {
    ...
    //SERVICES OFFER LIST REMOVE - APPEND
    $(".lis-wor-his-rem-btn").on('click', function () {
        var _removListSer = $(".add-list-ser ul li").length;
        if(_removListSer >= 2){
            $(".add-list-ser ul li:last-child").remove();
        }
    ...
    // Function to handle the background color change on input fields
    // function applyBackgroundChangeListener() {
    //     var inputFields = $(this).closest(".row").find("input[type=time]");
    ...
    // // Event listener for input fields' change event to handle background color change
    // $(".slots-container").on('change', 'input[type=time]', applyBackgroundChangeListener);
    ...
    function applyBackgroundChangeListener() {
      ...
      function calculateDateDifference(index) {
        ...
        var fromDateInput = document.getElementById("work_from" + index);
        var toDateInput = document.getElementById("work_to" + index);
        var expYearMonthInput = document.getElementById("exp_year_month" + index);
        ...
        var diffDate = new Date(diffMilliseconds);
        
        // Calculate the difference in days, months, and years
        var oneDayMilliseconds = 24 * 60 * 60 * 1000;
        var daysDiff = Math.floor(diffMilliseconds / oneDayMilliseconds);
        var yearsDiff = Math.floor(daysDiff / 365);
        var monthsDiff = Math.floor((daysDiff % 365) / 30); // Assuming 30 days in a month for simplicity
        
        // Set the difference as the value of the exp_year_month input
        expYearMonthInput.classList.add('has-value');
        expYearMonthInput.value = yearsDiff + " years, " + monthsDiff + " months";
        }
    ...
    //         expYearMonthInput.classList.remove('has-value');
    //         expYearMonthInput.value = "";
    //         return;
    //       }
    ...
    //       const yearsDiff = Math.floor(diffMilliseconds / (365 * 24 * 60 * 60 * 1000));
    //       const monthsDiff = Math.floor((diffMilliseconds % (365 * 24 * 60 * 60 * 1000)) / (30 * 24 * 60 * 60 * 1000));
