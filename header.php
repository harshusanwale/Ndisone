                                            ...
                                            <ul>
                                                ...
                                                ?>
                                                    <?php if ($footer_row['admin_listing_show'] == 1 && $user_details_row['setting_listing_show'] == 1) { ?>
                                                        ...
                                                        <li>
                                                            <a href="<?php echo $slash; ?>add-listing-start"><img src="<?php echo $slash; ?>images/icon/dbl3.png" alt="" loading="lazy" /><?php echo $BIZBOOK['ADD_LISTING']; ?>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#"><img src="<?php echo $slash; ?>images/icon/employee.png" alt="" loading="lazy" /><?php echo $BIZBOOK['COMPANY_DETAILS']; ?>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#"><img src="<?php echo $slash; ?>images/icon/cart.png" alt="" loading="lazy" /><?php echo $BIZBOOK['SERVICE_CATEGORIES']; ?>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#"><img src="<?php echo $slash; ?>images/icon/calendar.png" alt="" loading="lazy" /><?php echo $BIZBOOK['SERVICES_OFFERED']; ?>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#"><img src="<?php echo $slash; ?>images/icon/blog1.png" alt="" loading="lazy" /><?php echo $BIZBOOK['SERVICES_LOCATIONS']; ?>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#"><img src="<?php echo $slash; ?>images/icon/coupons.png" alt="" loading="lazy" /><?php echo $BIZBOOK['WORKING_HOURS']; ?>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#"><img src="<?php echo $slash; ?>images/icon/coupons.png" alt="" loading="lazy" /><?php echo $BIZBOOK['OTHERS']; ?>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#"><img src="<?php echo $slash; ?>images/icon/expert.png" alt="" loading="lazy" /><?php echo $BIZBOOK['SERVICE_LEADS']; ?>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#"><img src="<?php echo $slash; ?>images/icon/employee.png" alt="" loading="lazy" /><?php echo $BIZBOOK['POST_JOBS']; ?>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#"><img src="<?php echo $slash; ?>images/icon/dbl13.png" alt="" loading="lazy" /><?php echo $BIZBOOK['REVIEW_APP']; ?>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#"><img src="<?php echo $slash; ?>images/icon/dbl13.png" alt="" loading="lazy" /><?php echo $BIZBOOK['REVIEW_APP']; ?>
                                                        ...
                                                        <li>
                                                            <a href="#"><img src="<?php echo $slash; ?>images/icon/cart.png" alt="" loading="lazy" /><?php echo $BIZBOOK['LIST_RENTAL_PRO']; ?>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#"><img src="<?php echo $slash; ?>images/icon/cart.png" alt="" loading="lazy" /><?php echo $BIZBOOK['LIST_PRO_FOR_SALE']; ?>
                                                            </a>
                                                        </li>
                                                ...
                                                <li>
                                                    <a href="#"><img src="<?php echo $slash; ?>images/icon/cart.png" alt="" loading="lazy" /><?php echo $BIZBOOK['PRODUCTS']; ?>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#"><img src="<?php echo $slash; ?>images/icon/shop.png" alt="" loading="lazy" /><?php echo $BIZBOOK['INVENTORY']; ?>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#"><img src="<?php echo $slash; ?>images/icon/blog1.png" alt="" loading="lazy" /><?php echo $BIZBOOK['ORDERS']; ?>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#"><img src="<?php echo $slash; ?>images/icon/blog1.png" alt="" loading="lazy" /><?php echo $BIZBOOK['ORDER_HISTORY']; ?>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#"><img src="<?php echo $slash; ?>images/icon/dbl9.png" alt="" loading="lazy" /><?php echo $BIZBOOK['PAYMENTS']; ?>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#"><img src="<?php echo $slash; ?>images/icon/profile.png" alt="" loading="lazy" /><?php echo $BIZBOOK['CUSTOMERS']; ?>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#"><img src="<?php echo $slash; ?>images/icon/cart.png" alt="" loading="lazy" /><?php echo $BIZBOOK['VEHICLE_FOR_SALE']; ?>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#"><img src="<?php echo $slash; ?>images/icon/profile.png" alt="" loading="lazy" /><?php echo $BIZBOOK['CREATE_NEW_USER']; ?>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#"><img src="<?php echo $slash; ?>images/icon/profile.png" alt="" loading="lazy" /><?php echo $BIZBOOK['USER_ROLE_MANAG']; ?>
                                                    </a>
                                                </li>
                                                <?php
                                                if ($user_details_row['user_type'] == "Service provider") {  //To Check User type is Service provider
                                                ...
                                                <li>
                                                    <a href="#" class=""><img src="<?php echo $slash; ?>images/icon/calendar.png" alt="" loading="lazy" /><?php echo $BIZBOOK['POST_EVENTS']; ?></a>
                                                </li>
