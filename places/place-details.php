                        ...
                        <ul class="multiple-items1">
                            ...
                            foreach ($place_events as $item) {
                                ...
                                <li>
                                    <div class="plac-hom-box">
                                        <div class="plac-hom-box-im">
                                            <img src="<?php echo $slash; ?>images/events/<?php echo $place_events['event_image']; ?>" alt="" loading="lazy">
                        ...
                        <ul class="multiple-items1">
                            ...
                            foreach ($places_news as $item) {
                                ...
                                <li>
                                    <div class="plac-hom-box">
                                        <div class="plac-hom-box-im">
                                            <img src="<?php echo $slash; ?>/news/images/news/<?php echo $places_news['news_image']; ?>" alt="" loading="lazy">
