...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['listing_submit'])) {
        ...
        $listing_qry =
            "UPDATE  " . TBL . "listing_new  SET listing_is_delete='" . $listing_delete_status . "', listing_delete_cdt ='" . $curDate. "'  where listing_id='" . $listing_id . "'";
        ...
        if ($listing_res) {
            ...
            header('Location: delete-listing-new?row=' . $listing_code);
        }
