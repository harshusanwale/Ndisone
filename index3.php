                    ...
                    <ul class="multiple-items1">
                        <li>
                            <div class="testmo hom4-prop-box">
                                <img src="images/listings/14271pexels-pixabay-207684.jpg" alt="" loading="lazy">
                                <div>
                        ...
                        <li>
                            <div class="testmo hom4-prop-box">
                                <img src="images/listings/24505pexels-photo-2365572.jpeg" alt="" loading="lazy">
                                <div>
                                <h4><a href="#">Claude D Dial</a></h4>
                                <label class="rat">
                                    <i class="material-icons">star</i>
                        ...
                        <li>
                            <div class="testmo hom4-prop-box">
                                <img src="images/listings/72048pexels-francesco-ungaro-96444-(1).jpg" alt="" loading="lazy">
                                <div>
                                <h4><a href="#">Claude D Dial</a></h4>
                                <label class="rat">
                                    <i class="material-icons">star</i>
