            ...
            <div class="login-main" style="width: auto !important;">
                ...
                <div class="log log-1">
                    ...
                    <div class="login login-new">
                        ...
                        ?>
                        <form action="register_update_sc_form.php" id="register_update_stap1" name="register_update_stap1" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <select name="access_methods" id="access_methods" class=" form-control" require>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <select name="age_groups" id="age_groups" class=" form-control">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <select name="service_locations" id="service_locations" class="form-control" autocomplete="off" onchange="updateLocation()">
                                            <option value="">Service Locations</option>
                                            <?php
                                            foreach (getAllLocations() as $locations_row) {
                                                ?>
                                                <option
                                                    value="<?php echo $locations_row['location_id']; ?>" data-value="<?php echo $locations_row['location_state']; ?>" ><?php echo $locations_row['location_city']; ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" id="location_value" value="<?php echo $user_details_row['locations']; ?>" class="form-control" disabled>
                                    </div>
                                </div>
                            </div>

                            <div class="form-group">
                                <input type="text" autocomplete="off" value="<?php echo $user_details_row['registration_no']; ?>" name="registration_no" id="registration_no" class="form-control" placeholder="<?php echo $BIZBOOK['REGISTRATION NUMBER']; ?>">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="fil-img-uplo">
                                            <span class="dumfil"><?php echo $BIZBOOK['']; ?> Accredited Provider STAMP</span>
                                            <input type="file" name="accredited_provider_stamp" id="accredited_provider_stamp" accept="image/*,.jpg,.jpeg,.png" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button name="register_1_submit" type="submit" class="btn btn-primary"><?php echo $BIZBOOK['NEXT']; ?></button>
                                </div>
                                <!-- <div class="col-md-12">
...
<script>
    ...
    $(document).ready(function() {
        $('#register_update_stap1').validate({
...
<script>
    function updateLocation() {
        var selectBox = document.getElementById("service_locations");
        var locationValue = selectBox.options[selectBox.selectedIndex].getAttribute("data-value");
