...
<section class="<?php if($footer_row['admin_language']== 2){ echo "lg-arb";}?>  eve-deta-pg">
    <div class="container">
        <div class="eve-deta-pg-main">
            ...
            <div class="lhs">
                <div class="img">
                    <img src="<?php echo $slash; ?>images/blogs/<?php echo $blogs_a_row['blog_image']; ?>" alt="" loading="lazy">
                </div>
                    ...
                    foreach (getExceptBlog($blog_id,$blog_category_id) as $blogrow) {
                        ...
                        <li>
                            <div class="pro-eve-box">
                                <div>
                                    <img src="<?php echo $slash; ?>images/blogs/<?php echo $blogrow['blog_image']; ?>" alt="" loading="lazy">
                                </div>
                                <div>
