    ...
    <div class="container">
            ...
            <div class="add-list-ste">
                <div class="add-list-ste-inn">
                    ...
                    <li>
                        ...
                        <li>
                            <a href="edit-listing-step-new-8?row=<?php echo $listing_codea; ?>" class="act">
        ...
        <div class="row">
            <div class="login-main add-list">
                ...
                <span class="steps"><?php echo $BIZBOOK['STEP8']; ?></span>
                <div class="log">
                    <div class="login add-lis-oth">
                        ...
                        <form action="listing_update_new.php" class="listing_form_5" id="listing_form_5"
                            ...
                            <input type="hidden" id="src_path" value="edit-8"
